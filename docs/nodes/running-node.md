...
[View complete file](https://github.com/koinos/koinos-docs/blob/dev/examples/node-operators/observer/preflight.sh) ·
[Run locally](https://github.com/koinos/koinos-docs/tree/dev/examples/node-operators/observer#run-locally)
...
[View complete file](https://github.com/koinos/koinos-docs/blob/dev/examples/node-operators/observer/env.example) ·
[Use locally](https://github.com/koinos/koinos-docs/tree/dev/examples/node-operators/observer#prepare-the-official-repository)
...
[View complete file](https://github.com/koinos/koinos-docs/blob/dev/examples/node-operators/observer/start-observer.sh) ·
[Run locally](https://github.com/koinos/koinos-docs/tree/dev/examples/node-operators/observer#run-locally)
...
[View complete file](https://github.com/koinos/koinos-docs/blob/dev/examples/node-operators/observer/health-check.sh) ·
[Run locally](https://github.com/koinos/koinos-docs/tree/dev/examples/node-operators/observer#run-locally)
